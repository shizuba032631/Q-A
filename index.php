...
<head>
  ...
  <title>SHIAUKA FUJIMOTO ポートフォリオ</title>
        ...
        <div class="container">
          ...
          <div class="profile">
            ...
            <div class="profile-body">
              ...
              <p>
                山口県在住。フリーランスとしてWeb制作をしております。2014年より5年間医療業界で営業職として務めておりました。予てよりやってみたい事でありましたwebサイトの製作を2024年より本業にしました。Web制作におけるデザイン、コーディング、スマートフォンサイト対応、WordPressなどが得意分野です。低予算でWebサイトをお作りしますので、お気軽にお問い合わせください。
              </p>
